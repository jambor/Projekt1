...
Messages.quit = "Tényleg kilépsz?"
Messages.username_prompt = "add meg a felhasználóneved"
Messages.enter_password = "írja be a jelszavát"
Messages.enter_import_password = "írja be az importált jelszavát"
Messages.incorrect_password = "hibás jelszó"
Messages.repeat_password = "ismételd meg a jelszavad"
Messages.passwords_differ = "a két jelszó nem egyezik"
Messages.installation_finished = "Sikeres telepítés"
Messages.cat_dir_exisits = "Könyvtár {} létezik; néhány fájl " \
    "felülírásra kerül"
Messages.cont = "Folytatja?"
Messages.nm_not_supported = "Ez a NetworkManager verzió nem " \
    "támogatott"
Messages.cert_error = "A tanúsítványfájl nem található, úgy " \
    "néz ki, mint egy CAT hiba"
Messages.unknown_version = "Ismeretlen verzió"
Messages.dbus_error = "DBus kapcsolat probléma, a sudo segíthet"
Messages.yes = "I"
Messages.no = "N"
Messages.p12_filter = "a személyes tanúsítványt tartalmazó (p12 " \
    "vagy pfx) fájl"
Messages.all_filter = "Minden fájl"
Messages.p12_title = "a személyes tanúsítványt tartalmazó (p12 " \
    "vagy pfx) fájl"
Messages.save_wpa_conf = "A NetworkManager konfigurációja nem " \
    "sikerült, de ha szükséges, létrehozhatunk egy wpa_supplicant " \
    "konfigurációs fájlt. Figyelmeztetés: a jelszavad olvasható " \
    "szövegként kerül mentésre ebben a fájlban."
Messages.save_wpa_confirm = "Fájl írása"
Messages.wrongUsernameFormat = "Hiba: A felhasználónévnek az 'xxx @ " \
    "intézményazonosító' formátumnak kell lennie pl. " \
    "'John@pelda.net'!"
Messages.wrong_realm = "Hiba: a felhasználónévnek 'xxx@{}' " \
    "formátumúnak kell lennie. Kérjük, adja meg a felhasználónevet a " \
    "megfelelő formátumban."
Messages.wrong_realm_suffix = "Hiba: a felhasználónevének " \
    "'xxx@intézményazonosító' formátumúnak kell lennie, és '{}' kell " \
    "végződnie. Kérjük, adja meg a felhasználónevet a megfelelő " \
    "formátumban."
Messages.user_cert_missing = "személyes tanusítvány fájl nem " \
    "található"
Config.instname = "Diákháló"
Config.profilename = "Diákháló edu profile"
Config.url = "https://kifu.gov.hu/iskolai-eduroam-hasznalata/"
Config.email = "ugyfelszolgalat@kifu.hu"
Config.title = "eduroam CAT"
Config.server_match = "radius.eduroam.sulinet.hu"
Config.eap_outer = "PEAP"
Config.eap_inner = "MSCHAPV2"
Config.init_info = "Erre a telepítőprogramra készült " \
    "{0}\n\nTovábbi információk és hozzászólások:\n\nEMAIL: " \
    "{1}\nWWW: {2}\n\nA telepítő a GEANT projektből származó " \
    "szoftverrel készült."
Config.init_confirmation = "Ez a telepítő csak akkor működik " \
    "megfelelően, ha tagja {0}-nak."
Config.user_realm = "edu.hu"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius.eduroam.sulinet.hu']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@edu.hu"
Config.verify_user_realm_input = True
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""
